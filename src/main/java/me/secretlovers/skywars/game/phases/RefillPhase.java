...
public class RefillPhase implements Phase {

    private int time;
    private String name;

    public RefillPhase(int t) {
        time = t;
        name = "Refill";
    }
        ...
        return game -> {
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    if(game.getCurrentPhase().getClass() != RefillPhase.class) cancel();
                    ...
                    if(timer <= 0) {
                        SkyWars.getInstance().getChestManager().resetChests();
                        game.nextPhase();
                        cancel();
                    }
